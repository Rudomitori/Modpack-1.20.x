...
const registerRailWaysRecipes = (event) => {
    ...
    event.recipes.gtceu.assembler('railways/track_create_andesite_narrow_from_steel')             
        .itemInputs('#tfc:rock/slabs', '4x #forge:nuggets/steel')
    ...
    event.recipes.gtceu.assembler('railways/track_create_andesite_narrow_from_vanadium_steel')             
        .itemInputs('#tfc:rock/slabs', '4x #forge:nuggets/vanadium_steel')
    ...
    event.recipes.createSequencedAssembly([
        ...
        event.recipes.createDeploying('create:incomplete_track', ['create:incomplete_track', '#tfc:rock/slabss']),
    ...
    event.recipes.createSequencedAssembly([
        ...
        event.recipes.createDeploying('railways:track_incomplete_create_andesite_wide', ['railways:track_incomplete_create_andesite_wide', '#tfc:rock/slabs']),
